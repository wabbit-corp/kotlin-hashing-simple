...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-hashing-simple", "1.0.2")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-hashing-simple")
        description.set("kotlin-hashing-simple")
        url.set("https://github.com/wabbit-corp/kotlin-hashing-simple")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-hashing-simple")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-hashing-simple.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-hashing-simple.git")
        }
    }
}
...
kover {
    ...
    //             // title.set("kotlin-hashing-simple Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-hashing-simple")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-hashing-simple/tree/master/src/main/kotlin")
