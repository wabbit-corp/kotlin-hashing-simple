...
- Canonical repo target: `kotlin-hashing-simple`. Useful entrypoints: `dev project show kotlin-hashing-simple`, `dev build kotlin-hashing-simple`, `dev check kotlin-hashing-simple`.
- Setup-managed files are regenerated with `dev setup kotlin-hashing-simple`; avoid hand-editing stamped generated files.
